...
public class CalculateTotalKomisi {
	...
	public void firstTest() throws InterruptedException {
	    ...
	    //total komisi
	    String actualTotalKomisi = driver.findElement(By.cssSelector(".sol-total-comission .ant-input-number-input")).getAttribute("value");
