...
public class VerifyValueOfSellingPrice {
	...
	public void firstTest() throws InterruptedException {
	    ...
	    //verify
	    Float beratPerKg = (float) 0.00180785; //ini lupa nilai nya dr mana
	    int hargaSOL = Integer.parseInt(price);
	    int ongkosPrintingSOL = Integer.parseInt(ongkos_printing);
	    int komisiCustomerSOL = Integer.parseInt(komisi_cust);
	    int DPP = hargaSOL + ongkosPrintingSOL;
	    
	    float sellingPrice = (DPP - komisiCustomerSOL) / beratPerKg;
	    System.out.println("expected selling price : " + sellingPrice);
